 ...
 */
export declare function useNode<S = null>(collect?: (node: Node) => S): Pick<Pick<import("../editor/useInternalEditor").useInternalEditorReturnType<S>, "inContext" | "store" | Exclude<keyof import("@craftjs/utils").ConditionallyMergeRecordTypes<S, {
    actions: {
...
}, "inContext" | "store" | Exclude<Exclude<keyof import("@craftjs/utils").ConditionallyMergeRecordTypes<S, {
    actions: {
        addLinkedNodeFromTree: (tree: import("../interfaces").NodeTree, parentId: string, id: string) => void;
        add: (nodeToAdd: Node | Node[], parentId: string, index?: number) => void;
        addNodeTree: (tree: import("../interfaces").NodeTree, parentId?: string, index?: number) => void;
